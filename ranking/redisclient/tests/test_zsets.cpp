...
void test_zsets(redis::client & c)
{
  ...
  test("zincrby");
  {
    c.zincrby("zset1", "zval3", 5L);
    ASSERT_EQUAL(c.zscore("zset1",  "zval3"), (uint64_t)3);
  ...
  test("zscore");
  {
    ASSERT_EQUAL(c.zscore("zset1", "zval1"), (uint64_t)2);
    ASSERT_EQUAL(c.zscore("zset1", "zval2"), (uint64_t)1);
    ASSERT_EQUAL(c.zscore("zset1", "zval3"), (uint64_t)3);
  }
  ...
  test("zunionstore");
  {
    ...
    ASSERT_EQUAL(c.zscore("zset4", "zval1"), (uint64_t)2.719);
    ASSERT_EQUAL(c.zscore("zset4", "zval2"), (uint64_t)2.234);
    ASSERT_EQUAL(c.zscore("zset4", "zval3"), (uint64_t)9.141);
    ASSERT_EQUAL(c.zscore("zset4", "zval4"), (uint64_t)8.0);
    ASSERT_EQUAL(c.zscore("zset4", "zval5"), (uint64_t)6.0);
    ...
    ASSERT_EQUAL(c.zcard("zset4"), 5L);
    ASSERT_EQUAL(c.zscore("zset4", "zval1"), (uint64_t)2.719);
    ASSERT_EQUAL(c.zscore("zset4", "zval2"), (uint64_t)1.234);
    ASSERT_EQUAL(c.zscore("zset4", "zval3"), (uint64_t)4.0);
    ASSERT_EQUAL(c.zscore("zset4", "zval4"), (uint64_t)5.0);
    ASSERT_EQUAL(c.zscore("zset4", "zval5"), (uint64_t)6.0);
    ...
    ASSERT_EQUAL(c.zcard("zset4"), 5L);
    ASSERT_EQUAL(c.zscore("zset4", "zval1"), (uint64_t)2.719*5);
    ASSERT_EQUAL(c.zscore("zset4", "zval2"), (uint64_t)1.234*5);
    ASSERT_EQUAL(c.zscore("zset4", "zval3"), (uint64_t)3.141*5);
    ASSERT_EQUAL(c.zscore("zset4", "zval4"), (uint64_t)3.0*3);
    ASSERT_EQUAL(c.zscore("zset4", "zval5"), (uint64_t)6.0*1);
  }
  ...
  test("zinterstore");
  {
    ...
    ASSERT_EQUAL(c.zcard("zset4"), 1L);
    ASSERT_EQUAL(c.zscore("zset4", "zval3"), (uint64_t)2.0);
