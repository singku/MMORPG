...
int init_processors()
{
    g_proto_processor->register_command(cache_cmd_ag_req_users_info, new CliGetPlayerCacheInfoCmdProcessor()); 
    g_proto_processor->register_command(db_cmd_get_cache_info, new DbGetPlayerCacheInfoCmdProcessor());
    g_proto_processor->register_command(cache_cmd_set_cache, new SetCacheCmdProcessor());
    g_proto_processor->register_command(cache_cmd_get_cache, new GetCacheCmdProcessor());
    g_proto_processor->register_command(cache_cmd_set_user_info_outdate, new SetUserInfoOutDateCmdProcessor());
